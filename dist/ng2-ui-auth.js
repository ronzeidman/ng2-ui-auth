...
(["1"], ["6","7","f","11","10","e","8","12","13"], function($__System) {

$__System.register("2", ["6", "3", "4", "7", "5", "8"], function(exports_1, context_1) {
  "use strict";
...
$__System.register("9", ["6", "a", "b", "3", "7", "5", "4", "8"], function(exports_1, context_1) {
  "use strict";
  var __moduleName = context_1 && context_1.id;
  var __decorate = (this && this.__decorate) || function(decorators, target, key, desc) {
    var c = arguments.length,
...
$__System.register("b", ["6", "7", "5", "4", "c", "d", "e"], function(exports_1, context_1) {
  "use strict";
  var __moduleName = context_1 && context_1.id;
  var __decorate = (this && this.__decorate) || function(decorators, target, key, desc) {
    var c = arguments.length,
    ...
    execute: function() {
      Oauth2 = (function() {
        ...
        Oauth2.prototype.open = function(options, userData) {
          ...
          return openPopup.concatMap(function(oauthData) {
...
$__System.register("c", ["6", "f", "5", "4", "10", "11", "e", "12", "13"], function(exports_1, context_1) {
  "use strict";
  var __moduleName = context_1 && context_1.id;
  var __decorate = (this && this.__decorate) || function(decorators, target, key, desc) {
    var c = arguments.length,
...
$__System.register("a", ["6", "c", "7", "5", "4", "e"], function(exports_1, context_1) {
  "use strict";
  var __moduleName = context_1 && context_1.id;
  var __decorate = (this && this.__decorate) || function(decorators, target, key, desc) {
    var c = arguments.length,
    ...
    execute: function() {
      Oauth1 = (function() {
        ...
        Oauth1.prototype.open = function(options, userData) {
          ...
          return this.http.post(serverUrl, JSON.stringify(this.defaults)).concatMap(function(response) {
...
$__System.register("14", ["6", "7", "3", "2", "9", "c", "b", "a", "d", "4", "15"], function(exports_1, context_1) {
  "use strict";
  var __moduleName = context_1 && context_1.id;
  var __decorate = (this && this.__decorate) || function(decorators, target, key, desc) {
    var c = arguments.length,
...
$__System.register("4", ["6"], function(exports_1, context_1) {
  "use strict";
  var __moduleName = context_1 && context_1.id;
  var __decorate = (this && this.__decorate) || function(decorators, target, key, desc) {
    var c = arguments.length,
...
$__System.register("d", ["6", "4"], function(exports_1, context_1) {
  "use strict";
  var __moduleName = context_1 && context_1.id;
  var __decorate = (this && this.__decorate) || function(decorators, target, key, desc) {
    var c = arguments.length,
...
$__System.register("3", ["f", "6", "4", "d"], function(exports_1, context_1) {
  "use strict";
  var __moduleName = context_1 && context_1.id;
  var __decorate = (this && this.__decorate) || function(decorators, target, key, desc) {
    var c = arguments.length,
...
$__System.register("15", ["6", "7", "4", "3"], function(exports_1, context_1) {
  "use strict";
  var __moduleName = context_1 && context_1.id;
...
$__System.register("1", ["14", "4", "3", "15"], function(exports_1, context_1) {
  "use strict";
  var __moduleName = context_1 && context_1.id;
  return {
...
(function(factory) {
  module.exports = factory(require("angular2/core.js"), require("angular2/http.js"), require("rxjs/Observable.js"), require("rxjs/add/observable/fromEvent.js"), require("rxjs/add/observable/interval.js"), require("rxjs/add/operator/concatMap.js"), require("rxjs/add/operator/map.js"), require("rxjs/add/operator/take.js"), require("rxjs/add/operator/takeWhile.js"));
});

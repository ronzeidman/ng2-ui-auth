...
(["1"], ["6","7","f","8","10","11","12","13","14","e"], function($__System) {
...
(function(factory) {
  module.exports = factory(require("angular2/core"), require("angular2/http"), require("rxjs/Observable"), require("rxjs/add/operator/map"), require("rxjs/add/observable/interval"), require("rxjs/add/observable/fromEvent"), require("rxjs/add/operator/concatMap"), require("rxjs/add/operator/take"), require("rxjs/add/operator/takeWhile"), require("rxjs/add/operator/mergeMap"));
});

...
(["1"], ["f","6","7","8","e","10","11","12","13","14"], function($__System) {
...
(function(factory) {
  module.exports = factory(require("rxjs/Observable"), require("angular2/core"), require("angular2/http"), require("rxjs/add/operator/map"), require("rxjs/add/operator/mergeMap"), require("rxjs/add/observable/interval"), require("rxjs/add/observable/fromEvent"), require("rxjs/add/operator/concatMap"), require("rxjs/add/operator/take"), require("rxjs/add/operator/takeWhile"));
});
